...
from src.domain.models import Ingredient, Pizza
from src.schemas import IngredientRead, PizzaCreate, PizzaRead, PizzaUpdate
...
async def create_pizza(payload: PizzaCreate, session: AsyncSession) -> PizzaRead:
    from src.domain.models import Restaurant  # local to avoid cycles
